...
public class CookieJwtAuthorizationFilter : ActionFilterAttribute, IAuthorizationFilter
{
    private readonly string _role;
    private readonly string secretKey;
    public CookieJwtAuthorizationFilter(string role, IConfiguration configuration)
    {
        _role = role;
