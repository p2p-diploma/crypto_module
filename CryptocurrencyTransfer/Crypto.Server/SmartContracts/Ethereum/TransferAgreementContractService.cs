...
namespace Crypto.SmartContracts.Ethereum;
...
public class TransferAgreementContractService
{
    ...
    {
        var denyTransferFunction = new DenyTransferFunction { SlotId = slotId };
        return ContractHandler.SendRequestAsync(denyTransferFunction);
    }
    ...
    {
        var storeInBlockFunction = new StoreInBlockFunction { SlotId = slotId, Recipient = recipient };
        return ContractHandler.SendRequestAsync(storeInBlockFunction);
    }
    ...
    {
        var transferToRecipientFunction = new TransferToRecipientFunction { SlotId = slotId };
        return ContractHandler.SendRequestAsync(transferToRecipientFunction);
    }
