...
public class EthereumWalletsRepository : IWalletsRepository<EthereumWallet<ObjectId>, ObjectId>
{
    ...
    private IMongoCollection<EthereumWallet<ObjectId>> Accounts => _database.GetCollection<EthereumWallet<ObjectId>>(_collectionName);
    ...
    public async Task CreateAsync(EthereumWallet<ObjectId> ethereumWallet, CancellationToken token = default) => 
